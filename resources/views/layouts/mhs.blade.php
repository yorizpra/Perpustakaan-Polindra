...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" href="{{ url('/dashboard_mahasiswa') }}">Perpustakaan Polindra</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="{{ url('/pinjambarangmhs') }}">Pinjam Buku<span class="sr-only">(current)</span></a>
            </li>
            <!-- <li class="nav-item active">
